            ...
            <div class="row header-row">
                <div class="col-md-12">
                    <nav class="navbar navbar-default">
                        <a href="index.html"><img src="img/LOGO_ST.png" alt="" class="logo" width="80" height="65"></a>
            ...
            <div class="row">
                ...
                <div class="col-md-3 single-about col-xs-6 col-sm-4">
                    ...
                    <div class="about-inside">
                        <img src="img/acceso.png" alt="Login" width="150" height="150"/>
                ...
                <div class="col-md-3 single-about col-xs-6 col-sm-4">
                    <div class="about-inside">
                        <img id="registro" src="img/registro.png" alt="Registro" width="150" height="150"/>
                        <h3>Registro</h3>
            ...
            <div class="diferencias-heading">
                ...
                <div class="col-md-3 single-portfolio col-sm-6">
                    ...
                    <figure class="portfolio-item">
                        <img class="img-responsive" src="img/otros.jpg" alt="">
                ...
                <div class="col-md-3 single-portfolio col-sm-6">
                    ...
                    <br />
                    <figure class="portfolio-item">
                        <img class="img-responsive" src="img/bolsadetrabajo.jpg" alt="">
                        <figcaption class="portfolio-details">
                            <h4><u>RESULTADO</u></h4>
                            <br />
                            <ul class="diferencias">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <img class="img-responsive" src="img/Comparativo.jpg" alt="Comparativo SomosTalentos">
                    <br />
                    <img class="img-responsive" src="img/Comparativo_2.jpg" alt="Comparativo SomosTalentos">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="portfolio text-center" id="servicios">
        <div class="row portfolio-row">
            <div class="servicios-heading">
                ...
                <div class="col-md-3 single-portfolio col-sm-6">
                    <figure class="portfolio-item">
                        <img class="img-responsive" src="img/platicas.jpg" alt="">
                    </figure>
                </div>

                <div class="col-md-3 single-portfolio col-sm-6">
                    <figure class="portfolio-item">
                        <img class="img-responsive" src="img/platicas2.jpg" alt="">
                    </figure>
                </div>
